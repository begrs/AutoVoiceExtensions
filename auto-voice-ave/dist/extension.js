...
const configuration_provider_1 = __webpack_require__(3);
const webEndpoint_1 = __webpack_require__(4);
class Ave {
    constructor() {
        this.toggleListenCommand = "auto-voice-ave.listen";
        this.activateCommand = "auto-voice-ave.activate";
    ...
    showNotification(message, showDuringStartup = true) {
...
class ConfigurationProvider {
    showNotifications() {
        ...
        let val = this.getConfiguration().get(settingsKey);
        if (val) {
            return val;
        }
        else {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.WebEndpoint = void 0;
const node_fetch_1 = __webpack_require__(6);
class WebEndpoint {
    constructor(baseurl) {
        this.baseurl = baseurl;
        this.genericError = "Local AVE web api server could not be reached.";
    }
    startListening() {
...
exports.WebEndpoint = WebEndpoint;
...
const vscode = __webpack_require__(2);
const ave_1 = __webpack_require__(1);
